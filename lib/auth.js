...
var LocalAuthProvider = require('./provider/local.js')
...
//  )
  ...
  function cmd_register_service(args, callback) {
    seneca.log.info('registering auth service', args)
    passport.use(args.service, args.plugin, args.callback)

    serviceRouter.registerService(args.service, args.conf)
    callback()
  }
...
//  seneca.use('./provider/local.js')
  registerLocalAuth()

  return {
    name: plugin
  }
  function registerLocalAuth() {
