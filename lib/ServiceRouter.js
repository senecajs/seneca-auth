...
ServiceRouter.prototype.middleware = function() {
  ...
  authMiddlewares.use(this._passportInitialize, this)
  authMiddlewares.use(require('./middleware/senecaSession.js'))
  authMiddlewares.use(require('./middleware/restrictAuthOnly.js'))
