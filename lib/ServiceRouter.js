...
ServiceRouter.prototype._redirection = function(req, res, kind) {
  ...
  if( redirect ) {
    ...
    var win = _.isString(req.query.win) ? req.query.win : transientPrefix + ( (rk && rk.win)  || this._options.redirect.win )
    var fail = _.isString(req.query.fail) ? req.query.fail : transientPrefix + ( (rk && rk.fail) || this._options.redirect.fail )
